...
// its name directly.
const ConcedeGame = ({clickHandler}) => {
    ...
    return (<> 
        <button type="button" onClick={ // a button 'Get Courses' is created. When it's clicked, data is fetched.
            () => {
                ...
                const response = fetch('http://localhost:3000/battleship/concede', requestBody)
